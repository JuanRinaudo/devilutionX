...
typedef enum inv_body_loc {
	...
	INVLOC_HAND_RIGHT   = 5,
	INVLOC_CHEST        = 6,
	INVLOC_RING_LEFT_2  = 7,
	INVLOC_RING_RIGHT_2 = 8,
	NUM_INVLOC,
} inv_body_loc;
...
typedef enum inv_item {
	...
	INVITEM_RING_LEFT_2  = 3,
	INVITEM_RING_RIGHT_2 = 4,
	INVITEM_AMULET       = 5,
	INVITEM_HAND_LEFT    = 6,
	INVITEM_HAND_RIGHT   = 7,
	INVITEM_CHEST        = 8,
	INVITEM_INV_FIRST    = 9,
	INVITEM_INV_LAST     = 56,
	INVITEM_BELT_FIRST   = 57,
	INVITEM_BELT_LAST    = 64,
	NUM_INVELEM
} inv_item;
...
typedef enum inv_xy_slot {
	...
	SLOTXY_RING_LEFT        = 4,
	SLOTXY_RING_RIGHT       = 5,
	SLOTXY_RING_LEFT_2      = 6,
	SLOTXY_RING_RIGHT_2     = 7,
	SLOTXY_AMULET           = 8,
	SLOTXY_HAND_LEFT_FIRST  = 9,
	SLOTXY_HAND_LEFT_LAST   = 14,
	SLOTXY_HAND_RIGHT_FIRST = 15,
	SLOTXY_HAND_RIGHT_LAST  = 20,
	SLOTXY_CHEST_FIRST      = 21,
	SLOTXY_CHEST_LAST       = 26,
